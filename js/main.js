...
const attackerFactionSelectEl = document.querySelector(
  "#attackers_faction_select"
);
const defenderFactionSelectEl = document.querySelector(
  "#defenders_faction_select"
);
...
const attackerWeaponSelectEl = document.querySelector(
  "#attackers_weapon_select"
);
...
let mechanicusAttackerProtectorEl = document.getElementById(
  "mechanicusArmyRuleAttackerProtector"
);
...
const deathWatchBoltWeaponsArr = [
...
function tempMakeTransparent(string) {
  ...
  stringArr[0] = "rgba(";
  stringArr[1] = stringArr[1].split(")");
  stringArr[1][1] = ", 0.1)";
  stringArr[1][0] = stringArr[1][0].split(" ");
  stringArr[1][0] = stringArr[1][0].join(" ,");
  stringArr[1] = stringArr[1].join("");
    ...
    for (let a = 0, b = coloursToGenerate; a < b; a++) {
      ...
      splitColours.forEach((colour, index) => {
        ...
        if (255 - parseInt(colour) <= 127) {
          ...
          outColours[coloursToGenerate - (a + 1)].push(
            Math.round(parseInt(colour) - range * a)
          );
        } else {
          //closer to 0
          range = (255 - parseInt(colour)) / (coloursToGenerate + 1);
          outColours[coloursToGenerate - (a + 1)].push(
            Math.round(range * a + parseInt(colour))
          );
        }
      });
    }
...
function simulateAttackSequence() {
  ...
  let attackerKeywords = document
    .querySelector(`#attackerTags`)
    .value.split(", ");

  //defender variables, can all be grabbed now.

  //number of defenders
  let defenderCount = parseInt(
    document.querySelector(`#defenderCount-${selectedDefenderUnit}`).value
  );
  //wounds
  let wounds = parseInt(
    document.querySelector(`#wounds-${selectedDefenderUnit}`).value
  );
  let remainingDefenderWounds = wounds;
  let deadDefenders = 0;
  let toughness = parseInt(
    document.querySelector(`#toughness-${selectedDefenderUnit}`).value
  );

  let defenderKeywords = document.querySelector(
    `#defenderTags-${selectedDefenderUnit}`
  ).value;
  ...
  let attackerBattleshocked = document.getElementById(
    "generalAttackerBattleshocked"
  ).checked;
  let attackerBelowStartingStrength = document.getElementById(
    "generalAttackerBelowStartingStrength"
  ).checked;
  let attackerBelowHalfStrength = document.getElementById(
    "generalAttackerBelowHalfStrength"
  ).checked;
  let defenderBattleshocked = document.getElementById(
    "generalDefenderBattleshocked"
  ).checked;
  let defenderBelowStartingStrength = document.getElementById(
    "generalDefenderBelowStartingStrength"
  ).checked;
  let defenderBelowHalfStrength = document.getElementById(
    "generalDefenderBelowHalfStrength"
  ).checked;
  ...
  let sororitasBoM = document.getElementById(
    "adeptaSororitasDetachmentBoM"
  ).checked;
  let sororitasBlade = document.getElementById(
    "adeptaSororitasEnhancementBlade"
  ).checked;
  let sororitasMantle = document.getElementById(
    "adeptaSororitasEnhancementMantle"
  ).checked;
  let sororitasStratagemLightAttacker = document.getElementById(
    "sororitasStratagemLightAttacker"
  ).checked;
  let sororitasStratagemRage = document.getElementById(
    "sororitasStratagemRage"
  ).checked;
  let sororitasStratagemLightDefender = document.getElementById(
    "sororitasStratagemLightDefender"
  ).checked;
  let custodesDacatari = document.getElementById(
    "custodesArmyRuleDacatari"
  ).checked;
  let custodesRendax = document.getElementById(
    "custodesArmyRuleRendax"
  ).checked;
  let custodesKaptaris = document.getElementById(
    "custodesArmyRuleKaptaris"
  ).checked;
  let custodesAegis = document.getElementById(
    "custodesDetachmentRuleAegis"
  ).checked;
  let custodesStratagemNightmares = document.getElementById(
    "custodesStratagemNightmares"
  ).checked;
  let custodesStratagemFallen = document.getElementById(
    "custodesStratagemFallen"
  ).checked;
  let custodesStratagemAlchemy = document.getElementById(
    "custodesStratagemAlchemy"
  ).checked;
  let custodesBlade = document.getElementById(
    "custodesEnhancementBlade"
  ).checked;
  let mechanicusAttackerProtector = mechanicusAttackerProtectorEl.checked;
  let mechanicusConqueror = document.getElementById(
    "mechanicusArmyRuleConqueror"
  ).checked;
  let mechanicusDefenderProtector = document.getElementById(
    "mechanicusArmyRuleDefenderProtector"
  ).checked;
  let mechanicusStratagemDosage = document.getElementById(
    "mechanicusStratagemDosage"
  ).checked;
  let mechanicusStratagemHalo = document.getElementById(
    "mechanicusStratagemHalo"
  ).checked;
  let mechanicusStratagemBulwark = document.getElementById(
    "mechanicusStratagemBulwark"
  ).checked;
  let mechanicusOmni = document.getElementById(
    "adeptusMechanicusEnhancementOmni"
  ).checked;
  let aeldariUnparalleledForesight = document.getElementById(
    "aeldariDetachmentUF"
  ).checked;
  let aeldariStratagemBladestorm = document.getElementById(
    "aeldariStratagemBladestorm"
  ).checked;
  let aeldariStratagemReactions = document.getElementById(
    "aeldariStratagemReactions"
  ).checked;
  let aeldariAttackerMessenger = document.getElementById(
    "aeldariEnhancementAttackerMessenger"
  ).checked;
  let aeldariDefenderMessenger = document.getElementById(
    "aeldariEnhancementDefenderMessenger"
  ).checked;
  let militarumBayonets = document.getElementById(
    "astraMilitarumArmyRuleAttackerBayonets"
  ).checked;
  let militarumAim = document.getElementById(
    "astraMilitarumArmyRuleAttackerAim"
  ).checked;
  let militarumFire = document.getElementById(
    "astraMilitarumArmyRuleAttackerFire"
  ).checked;
  let militarumBornSoldiers = document.getElementById(
    "astraMilitarumDetachmentBornSoldiers"
  ).checked;
  let militarumCover = document.getElementById(
    "astraMilitarumArmyRuleAttackerCover"
  ).checked;
  let militarumStratagemFields = document.getElementById(
    "astraMilitarumStratagemFields"
  ).checked;
  let militarumStratagemBombadiers = document.getElementById(
    "astraMilitarumStratagemBombadiers"
  ).checked;
  let militarumStratagemArmoured = document.getElementById(
    "astraMilitarumStratagemArmoured"
  ).checked;
  let templarsUnclean = document.getElementById(
    "blackTemplarsDetachmentTemplarVowsUnclean"
  ).checked;
  let templarsHonour = document.getElementById(
    "blackTemplarsDetachmentTemplarVowsHonour"
  ).checked;
  let templarsWitchAttacker = document.getElementById(
    "blackTemplarsDetachmentTemplarVowsWitchAttacker"
  ).checked;
  let templarsWitchDefender = document.getElementById(
    "blackTemplarsDetachmentTemplarVowsWitchDefender"
  ).checked;
  let templarsChallenge = document.getElementById(
    "blackTemplarsDetachmentTemplarVowsUncleanChallenge"
  ).checked;
  let templarsPerdition = document.getElementById(
    "blackTemplarsEnhancementPerdition"
  ).checked;
  let templarsWitchseeker = document.getElementById(
    "blackTemplarsEnhancementWitchseeker"
  ).checked;
  let templarsSigismund = document.getElementById(
    "blackTemplarsEnhancementSigismund"
  ).checked;
  let templarsTanhauser = document.getElementById(
    "blackTemplarsEnhancementTanhauser"
  ).checked;
  let bloodAngelsThirst = document.getElementById(
    "bloodAngelsDetachmentThirst"
  ).checked;
  let bloodAngelsArtisanAttacker = document.getElementById(
    "bloodAngelsEnhancementAttackerArtisan"
  ).checked;
  let bloodAngelsShard = document.getElementById(
    "bloodAngelsEnhancementAttackerShard"
  ).checked;
  let bloodAngelsArtisanDefender = document.getElementById(
    "bloodAngelsEnhancementDefenderArtisan"
  ).checked;
  let chaosDaemonsShadowAttacker = document.getElementById(
    "chaosDaemonsArmyRuleAttackerShadow"
  ).checked;
  let chaosDaemonsShadowDefender = document.getElementById(
    "chaosDaemonsArmyRuleDefenderShadow"
  ).checked;
  let chaosDaemonsArgath = document.getElementById(
    "chaosDaemonsEnhancementArgath"
  ).checked;
  let chaosDaemonsEverstave = document.getElementById(
    "chaosDaemonsEnhancementEverstave"
  ).checked;
  let chaosDaemonsGift = document.getElementById(
    "chaosDaemonsEnhancementGift"
  ).checked;
  let chaosKnightsAttackerDoom = document.getElementById(
    "chaosKnightsArmyRuleAttackerDoom"
  ).checked;
  let chaosKnightsDefenderDoom = document.getElementById(
    "chaosKnightsArmyRuleDefenderDoom"
  ).checked;
  let chaosKnightsPanoply = document.getElementById(
    "chaosKnightsEnhancementPanoply"
  ).checked;
  let CSMDarkPactLethal = document.getElementById(
    "CSMArmyRuleDarkPactLethal"
  ).checked;
  let CSMDarkPactSustained = document.getElementById(
    "CSMArmyRuleDarkPactSustained"
  ).checked;
  let CSMMarkKhorne = document.getElementById(
    "CSMDetachmentMarkKhorne"
  ).checked;
  let CSMMarkTzeentch = document.getElementById(
    "CSMDetachmentMarkTzeentch"
  ).checked;
  let CSMMarkNurgle = document.getElementById(
    "CSMDetachmentMarkNurgle"
  ).checked;
  let CSMMarkSlaanesh = document.getElementById(
    "CSMDetachmentMarkSlaanesh"
  ).checked;
  let CSMMarkUndivided = document.getElementById(
    "CSMDetachmentMarkUndivided"
  ).checked;
  ...
  let darkAngelsStubborn = document.getElementById(
    "darkAngelsEnhancementStubborn"
  ).checked;
  let darkAngelsBlade = document.getElementById(
    "darkAngelsEnhancementBlade"
  ).checked;
  let darkAngelsRememberance = document.getElementById(
    "darkAngelsEnhancementRememberance"
  ).checked;
  let deathGuardGift = document.getElementById(
    "deathGuardArmyRuleGift"
  ).checked;
  let deathGuardSSAttacker = document.getElementById(
    "deathGuardDetachmentSSAttacker"
  ).checked;
  let deathGuardSSDefender = document.getElementById(
    "deathGuardDetachmentSSDefender"
  ).checked;
  let deathGuardPathogen = document.getElementById(
    "deathGuardEnhancementPathogen"
  ).checked;
  let deathGuardPathogenInRange = document.getElementById(
    "deathGuardEnhancementPathogenInRange"
  ).checked;
  let deathwatchFuror = document.getElementById(
    "deathwatchDetachmentFuror"
  ).checked;
  let deathwatchMalleus = document.getElementById(
    "deathwatchDetachmentMalleus"
  ).checked;
  let deathwatchSecrets = document.getElementById(
    "deathwatchEnhancementSecrets"
  ).checked;
  let deathwatchSecretsKill = document.getElementById(
    "deathwatchEnhancementSecretsKill"
  ).checked;

  let deathwatchStratagemHellfire = document.getElementById(
    "deathwatchStratagemHellfire"
  ).checked;
  let deathwatchStratagemKraken = document.getElementById(
    "deathwatchStratagemKraken"
  ).checked;
  let deathwatchStratagemDragonfire = document.getElementById(
    "deathwatchStratagemDragonfire"
  ).checked;
  let deathwatchStratagemAoC = document.getElementById(
    "deathwatchStratagemAoC"
  ).checked;

  let drukhariPower = document.getElementById("drukhariArmyRulePower").checked;
  let drukhariDancer = document.getElementById(
    "drukhariEnhancementDancer"
  ).checked;
  let gscBelow = document.getElementById("GSCDetachmentBelow").checked;
  let greyKnightsDaemonica = document.getElementById(
    "greyKnightsEnhancementDaemonica"
  ).checked;
  // let impKnightsAttackerHonored = document.getElementById("imperialKnightsArmyRuleAttackerHonored").checked;
  let impKnightsLayLow = document.getElementById(
    "imperialKnightsArmyRuleLayLow"
  ).checked;
  let impKnightsDefenderHonored = document.getElementById(
    "imperialKnightsArmyRuleDefenderHonored"
  ).checked;
  let impKnightsIndomitable = document.getElementById(
    "imperialKnightsDetachmentIndomitable"
  ).checked;
  let impKnightsParagon = document.getElementById(
    "imperialKnightsEnhancementParagon"
  ).checked;
  let leagueAncestorsOne = document.getElementById(
    "leagueArmyRuleAncestorsOne"
  ).checked;
  let leagueAncestorsTwo = document.getElementById(
    "leagueArmyRuleAncestorsTwo"
  ).checked;
  let necronsCommand = document.getElementById(
    "necronsDetachmentCommand"
  ).checked;
  let necronsReanimation = document.getElementById(
    "necronsArmyRuleReanimation"
  ).checked;
  let reanimationRoll = 0;
  let reanimationModelsReanimated = [];
  let reanimationWoundsHealed = [];
  let necronsAblator = document.getElementById(
    "necronsEnhancementAblator"
  ).checked;
  let necronsAblatorFar = document.getElementById(
    "necronsEnhancementAblatorFar"
  ).checked;
  let necronsWeave = document.getElementById("necronsEnhancementWeave").checked;
  let orksWaaaghAttacker = document.getElementById(
    "orksArmyRuleAttacker"
  ).checked;
  let orksWaaaghDefender = document.getElementById(
    "orksArmyRuleDefender"
  ).checked;
  let orksGetStuckIn = document.getElementById(
    "orksDetachmentGetStuckIn"
  ).checked;
  let orksMekaniak = document.getElementById("orksUnitMekaniak").checked;
  let orkStratagemCarnage = document.getElementById(
    "orkStratagemCarnage"
  ).checked;
  let orkStratagemArd = document.getElementById("orkStratagemArd").checked;
  let orksKillChoppa = document.getElementById(
    "orksEnhancementKillchoppa"
  ).checked;
  let orksCybork = document.getElementById("orksEnhancementCybork").checked;
  let adeptusAstartesOath = document.getElementById(
    "adeptusAstartesArmyRuleAttacker"
  ).checked;
  let adeptusAstartesHonour = document.getElementById(
    "adeptusAstartesEnhancementHonour"
  ).checked;
  let adeptusAstartesHonourAssault = document.getElementById(
    "adeptusAstartesEnhancementHonourAssault"
  ).checked;
  let adeptusAstartesBolter = document.getElementById(
    "adeptusAstartesEnhancementBolter"
  ).checked;
  let adeptusAstartesBolterDevastator = document.getElementById(
    "adeptusAstartesEnhancementBolterDevastator"
  ).checked;
  let adeptusAstartesArtificer = document.getElementById(
    "adeptusAstartesEnhancementArtificer"
  ).checked;
  let spaceWolvesSagaWarrior = document.getElementById(
    "spaceWolvesDetachmentSagaWarrior"
  ).checked;
  let spaceWolvesSagaSlayer = document.getElementById(
    "spaceWolvesDetachmentSagaBeastslayer"
  ).checked;
  let spaceWolvesSagaBear = document.getElementById(
    "spaceWolvesDetachmentSagaBear"
  ).checked;
  let spaceWolvesBlack = document.getElementById(
    "spaceWolvesEnhancementBlack"
  ).checked;
  let spaceWolvesFrost = document.getElementById(
    "spaceWolvesEnhancementFrost"
  ).checked;
  let spaceWolvesTalisman = document.getElementById(
    "spaceWolvesEnhancementTalisman"
  ).checked;
  let tauGuided = document.getElementById("tauArmyRuleAttacker").checked;
  let tauObserverMarkerlight = document.getElementById(
    "tauArmyRuleAttackerMarkerlight"
  ).checked;
  let tauKauyon = document.getElementById("tauDetachmentKauyon").checked;
  let tauPatient = document.getElementById(
    "tauEmpireEnhancementPatient"
  ).checked;
  let thousandSonsWeaver = document.getElementById(
    "thousandSonsArmyRuleCabalWeaver"
  ).checked;
  let thousandSonsTwist = document.getElementById(
    "thousandSonsArmyRuleCabalTwist"
  ).checked;
  let thousandSonsMalevolent = document.getElementById(
    "thousandSonsDetachmentMalevolent"
  ).checked;
  let thousandSonsMaelstrom = document.getElementById(
    "thousandSonsDetachmentMaelstrom"
  ).checked;
  let thousandSonsImmaterium = document.getElementById(
    "thousandSonsDetachmentImmaterium"
  ).checked;
  let thousandSonsVortex = document.getElementById(
    "thousandSonsEnhancementVortex"
  ).checked;
  let tyranidSwarming = document.getElementById(
    "tyranidDetachmentSwarming"
  ).checked;
  let tyranidAggression = document.getElementById(
    "tyranidDetachmentAggression"
  ).checked;
  let tyranidAdaptedAttacker = document.getElementById(
    "tyranidsEnhancementAdaptedAttacker"
  ).checked;
  let tyranidAdaptedDefender = document.getElementById(
    "tyranidsEnhancementAdaptedDefender"
  ).checked;
  let tyranidAdaptive = document.getElementById(
    "tyranidsEnhancementAdaptive"
  ).checked;
  let tyranidAdaptiveWounded = document.getElementById(
    "tyranidsEnhancementAdaptiveWounded"
  ).checked;
  let worldEatersMartial = document.getElementById(
    "worldEatersArmyRuleMartial"
  ).checked;
  let worldEatersBlades = document.getElementById(
    "worldEatersArmyRuleBlades"
  ).checked;
  let worldEatersDevotion = document.getElementById(
    "worldEatersArmyRuleDevotion"
  ).checked;
  let worldEatersRelentless = document.getElementById(
    "worldEatersDetachmentRelentless"
  ).checked;
  let worldEatersGlaive = document.getElementById(
    "worldEatersEnhancementGlaive"
  ).checked;
  let worldEatersHelm = document.getElementById(
    "worldEatersEnhancementHelm"
  ).checked;
  let worldEatersGlaiveCharged = false;
  let stratagemTankShock = document.getElementById(
    "genericStratagemTankShock"
  ).checked;
  let stratagemGrenade = document.getElementById(
    "genericStratagemGrenade"
  ).checked;
  let stratagemGround = document.getElementById(
    "genericStratagemGround"
  ).checked;
  ...
  let generalFnp = parseInt(
    document.querySelector(`#fnp-${selectedDefenderUnit}`).value
  );
  ...
  if (stratagemTankShock) {
    ...
    weaponSelectEls.forEach((weaponEl) => {
      ...
      if (weaponMeleeRanged == "melee") {
        ...
        let weaponStrength = parseInt(
          data[chosenWeaponFaction].units[chosenWeaponUnit].weapons.melee[
            chosenWeaponName
          ].s
        );
  ...
  weaponSelectEls.forEach((weaponEl) => {
    ...
    let chosenWeaponName = weaponEl.getAttribute("data-weapon");
    weaponMeleeRanged = weaponEl.getAttribute("data-weapon-type");
    let chosenWeaponNameDif =
      chosenWeaponName +
      "-" +
      weaponMeleeRanged +
      "-" +
      weaponEl.getAttribute("data-weapon-extra");

    let chosenWeaponParentElement = document.querySelector(
      `#weapon${chosenWeaponName}-${weaponMeleeRanged}-${weaponEl.getAttribute(
        "data-weapon-extra"
      )}`
    );
    ...
    weaponStats[chosenWeaponNameDif] = {
      name: data[chosenWeaponFaction].units[chosenWeaponUnit].weapons[
        weaponMeleeRanged
      ][chosenWeaponName].name,
      ...
      save: parseInt(
        document.querySelector(`#save-${selectedDefenderUnit}`).value
      ),
      invul: parseInt(
        document.querySelector(`#invul-${selectedDefenderUnit}`).value
      ),
      fnp: parseInt(
        document.querySelector(`#fnp-${selectedDefenderUnit}`).value
      ),
    ...
    let weaponTags = chosenWeaponParentElement
      .querySelector(`#weaponTags${chosenWeaponName}-${weaponMeleeRanged}`)
      .value.split(", ");
    ...
    weaponTags.forEach((tag) => {
      switch (tag.split("-")[0]) {
        ...
        case "sustainedHits":
          ...
          weaponStats[chosenWeaponNameDif].sustainedHitsCount =
            tag.split("-")[1];
          break;
        case "extraAttacks":
        ...
        case "anti":
          if (!weaponStats[chosenWeaponNameDif].anti) {
            ...
            weaponStats[chosenWeaponNameDif].antiType +=
              ", " + tag.split("-")[1];
            weaponStats[chosenWeaponNameDif].antiValue +=
              ", " + tag.split("-")[2];
          }
          break;
      }
    ...
    //number of attackers
    weaponStats[chosenWeaponNameDif].attackerCount = parseInt(
      chosenWeaponParentElement.querySelector(
        `#attackerCount${chosenWeaponName}-${weaponMeleeRanged}`
      ).value
    );
    ...
    //attacks
    weaponStats[chosenWeaponNameDif].attackString =
      chosenWeaponParentElement.querySelector(
        `#attacks${chosenWeaponName}-${weaponMeleeRanged}`
      ).value;
    weaponStats[chosenWeaponNameDif].rollAttacks = false;
    if (
      weaponStats[chosenWeaponNameDif].attackString.includes("d") ||
      weaponStats[chosenWeaponNameDif].attackString.includes("D")
    ) {
      weaponStats[chosenWeaponNameDif].rollAttacks = true;
    } else {
      weaponStats[chosenWeaponNameDif].attackString = parseInt(
        weaponStats[chosenWeaponNameDif].attackString
      );
      weaponStats[chosenWeaponNameDif].rollAttacks = false;
    }
    ...
    weaponStats[chosenWeaponNameDif].hit = parseInt(
      chosenWeaponParentElement.querySelector(
        `#wbs${chosenWeaponName}-${weaponMeleeRanged}`
      ).value
    );

    //strength
    weaponStats[chosenWeaponNameDif].strength = parseInt(
      chosenWeaponParentElement.querySelector(
        `#strength${chosenWeaponName}-${weaponMeleeRanged}`
      ).value
    );

    //armour piercing
    weaponStats[chosenWeaponNameDif].ap = parseInt(
      chosenWeaponParentElement.querySelector(
        `#ap${chosenWeaponName}-${weaponMeleeRanged}`
      ).value
    );
    if (weaponStats[chosenWeaponNameDif].ap < 0) {
      weaponStats[chosenWeaponNameDif].ap =
        weaponStats[chosenWeaponNameDif].ap * -1;
    }
    // console.log(`ap: ${ap}`)

    //damage
    weaponStats[chosenWeaponNameDif].damageString =
      chosenWeaponParentElement.querySelector(
        `#damage${chosenWeaponName}-${weaponMeleeRanged}`
      ).value;
    weaponStats[chosenWeaponNameDif].rollDamage = false;
    if (
      weaponStats[chosenWeaponNameDif].damageString.includes("d") ||
      weaponStats[chosenWeaponNameDif].damageString.includes("D")
    ) {
      weaponStats[chosenWeaponNameDif].rollDamage = true;
    } else {
      weaponStats[chosenWeaponNameDif].damageString = parseInt(
        weaponStats[chosenWeaponNameDif].damageString
      );
      weaponStats[chosenWeaponNameDif].rollDamage = false;
    }
    ...
    if (
      sororitasStratagemRage &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "melee"
    ) {
      woundModifierArr.push(1);
    }
    ...
    if (
      ...
      if (!weaponStats[chosenWeaponNameDif].extraAttacks) {
        weaponStats[chosenWeaponNameDif].attackString = addToString(
          weaponStats[chosenWeaponNameDif].rollAttacks,
          weaponStats[chosenWeaponNameDif].attackString,
          2
        );
      }
    ...
    if (
      custodesDacatari &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "melee" &&
      !weaponStats[chosenWeaponNameDif].sustainedHits
    ) {
      weaponStats[chosenWeaponNameDif].sustainedHits = true;
    ...
    if (
      custodesStratagemNightmares &&
      (defenderKeywordsArray.includes("Vehicle") ||
        (defenderKeywordsArray.includes("Monster") &&
          weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "melee"))
    ) {
      woundModifierArr.push(1);
    }
    ...
    if (
      custodesStratagemAlchemy &&
      defenderKeywordsArray.includes("Infantry") &&
      !defenderKeywordsArray.includes("Anathema Psykana")
    ) {
      weaponStats[chosenWeaponNameDif].attackString = addToString(
        weaponStats[chosenWeaponNameDif].rollAttacks,
        weaponStats[chosenWeaponNameDif].attackString,
    ...
    if (
      mechanicusAttackerProtector &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "ranged"
    ) {
      weaponStats[chosenWeaponNameDif].heavy = true;
    }
    ...
    if (
      mechanicusStratagemHalo &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "melee" &&
      !attackerKeywords.includes("Vehicle")
    ) {
      woundModifierArr.push(-1);
    }
    if (
      mechanicusStratagemBulwark &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "ranged" &&
      defenderKeywordsArray.includes("Skitarii") &&
      mechanicusDefenderProtector
    ) {
      if (
        weaponStats[chosenWeaponNameDif].invul > 4 ||
        weaponStats[chosenWeaponNameDif].fnp == 0
      ) {
        weaponStats[chosenWeaponNameDif].invul = 4;
      }
    }
    ...
    if (
      aeldariStratagemReactions &&
      !defenderKeywordsArray.includes("Wraith Construct")
    ) {
      hitModifierArr.push(-1);
    }
    ...
    if (
      militarumBayonets &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "melee" &&
      weaponStats[chosenWeaponNameDif].hit > 2
    ) {
      weaponStats[chosenWeaponNameDif].hit =
        weaponStats[chosenWeaponNameDif].hit - 1;
    }
    ...
    if (militarumCover && weaponStats[chosenWeaponNameDif].save > 3) {
      weaponStats[chosenWeaponNameDif].save =
        weaponStats[chosenWeaponNameDif].save - 1;
    }

    if (
      militarumStratagemFields &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "ranged" &&
    ...
    if (
      militarumStratagemBombadiers &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "ranged" &&
      weaponStats[chosenWeaponNameDif].indirectFire &&
      !attackerBattleshocked
    ) {
      hitModifierArr.push(1);
    }
    if (
      militarumStratagemArmoured &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "ranged" &&
      defenderKeywordsArray.includes("Vehicle")
    ) {
      weaponStats[chosenWeaponNameDif].attackString = addToString(
    ...
    if (
      templarsHonour &&
      weaponStats[chosenWeaponNameDif].psychic &&
      (weaponStats[chosenWeaponNameDif].fnp > 5 ||
        weaponStats[chosenWeaponNameDif].fnp == 0 ||
        isNaN(weaponStats[chosenWeaponNameDif].fnp))
    ) {
      weaponStats[chosenWeaponNameDif].fnp = 5;
      generalFnp = 5;
    }
    ...
    if (
      templarsWitchAttacker &&
      defenderKeywordsArray.includes("Psyker") &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "melee"
    ) {
      weaponStats[chosenWeaponNameDif].anti = true;
      if (weaponStats[chosenWeaponNameDif].antiType == "") {
    ...
    if (
      templarsWitchDefender &&
      weaponStats[chosenWeaponNameDif].psychic &&
      (weaponStats[chosenWeaponNameDif].invul == 0 ||
        weaponStats[chosenWeaponNameDif].invul > 4)
    ) {
      weaponStats[chosenWeaponNameDif].invul = 4;
    }
    ...
    if (
      ...
      if (
        templarsChallenge &&
        weaponStats[chosenWeaponNameDif].criticalHit > 5 /* && leadingUnit*/
      ) {
    ...
    if (templarsTanhauser) {
      ...
      if (
        ...
        (weaponStats[chosenWeaponNameDif].fnp > 5 ||
          weaponStats[chosenWeaponNameDif].fnp == 0 ||
          isNaN(weaponStats[chosenWeaponNameDif].fnp)) /* && leadingUnit*/
      ) {
        weaponStats[chosenWeaponNameDif].fnp = 5;
        generalFnp = 5;
      }
    ...
    if (
      CSMTalisman &&
      (CSMDarkPactLethal || CSMDarkPactSustained) &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "melee"
    ) {
    ...
    if (darkAngelsBlade) {
      if (attackerBattleshocked) {
        ...
        weaponStats[chosenWeaponNameDif].damageString = addToString(
          weaponStats[chosenWeaponNameDif].rollAttacks,
          weaponStats[chosenWeaponNameDif].damageString,
          2
        );
    ...
    if (deathGuardGift) {
      weaponStats[chosenWeaponNameDif].toughness =
        weaponStats[chosenWeaponNameDif].toughness - 1;
    }
    ...
    if (
      deathwatchSecretsKill &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "melee"
    ) {
      weaponStats[chosenWeaponNameDif].strength += 2;
      weaponStats[chosenWeaponNameDif].ap += 2;
      weaponStats[chosenWeaponNameDif].damageString = addToString(
        weaponStats[chosenWeaponNameDif].rollDamage,
        weaponStats[chosenWeaponNameDif].damageString,
        2
      );
    } else if (
    ...
    if(deathwatchStratagemHellfire){
        if(deathWatchBoltWeaponsArr.includes(weaponStats[chosenWeaponNameDif].name)){
            weaponStats[chosenWeaponNameDif].anti = true;
            if (weaponStats[chosenWeaponNameDif].antiType == "") {
                weaponStats[chosenWeaponNameDif].antiType += "Infantry, Monster";
                weaponStats[chosenWeaponNameDif].antiValue += "2, 5";
              } else {
                weaponStats[chosenWeaponNameDif].antiType += ", Infantry, Monster";
                weaponStats[chosenWeaponNameDif].antiValue += ", 2, 5";
              }
    ...
    if(deathwatchStratagemKraken){
        if(deathWatchBoltWeaponsArr.includes(weaponStats[chosenWeaponNameDif].name)){
            weaponStats[chosenWeaponNameDif].ap += 1;
        };
    }

    if(deathwatchStratagemDragonfire){
        if(deathWatchBoltWeaponsArr.includes(weaponStats[chosenWeaponNameDif].name)){
            weaponStats[chosenWeaponNameDif].assault = true;
            weaponStats[chosenWeaponNameDif].ignoresCover = true;
        };
    ...
    if (
      greyKnightsDaemonica &&
      defenderKeywordsArray.includes("Daemon") &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "melee"
    ) {
      weaponStats[chosenWeaponNameDif].damageString = addToString(
        weaponStats[chosenWeaponNameDif].rollDamage,
    ...
    if (
      impKnightsDefenderHonored &&
      impKnightsIndomitable &&
      (weaponStats[chosenWeaponNameDif].fnp > 5 ||
        weaponStats[chosenWeaponNameDif].fnp == 0 ||
        isNaN(weaponStats[chosenWeaponNameDif].fnp))
    ) {
    ...
    if (
      orkStratagemArd &&
      !defenderKeywords.includes("Vehicle") &&
      !defenderKeywords.includes("Gretchin")
    ) {
      woundModifierArr.push(-1);
    }
    ...
    if (
      orksKillChoppa &&
      weaponStats[chosenWeaponNameDif].charactersWeapon &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "melee" &&
      !weaponStats[chosenWeaponNameDif].extraAttacks
    ) {
      weaponStats[chosenWeaponNameDif].devastatingWounds = true;
    }
    ...
    if (
      adeptusAstartesBolterDevastator &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged ==
        "ranged" /* && leadingUnit*/
    ) {
      if (!weaponStats[chosenWeaponNameDif].sustainedHits) {
        weaponStats[chosenWeaponNameDif].sustainedHits = true;
    ...
    if (
      tyranidSwarming &&
      (defenderKeywordsArray.includes("Infantry") ||
        defenderKeywordsArray.includes("Swarm")) &&
      !weaponStats[chosenWeaponNameDif].sustainedHits
    ) {
    ...
    if (worldEatersDevotion) {
      if (
        ...
        weaponStats[chosenWeaponNameDif].fnp =
          weaponStats[chosenWeaponNameDif].fnp - 1;
        generalFnp = generalFnp - 1;
      }
    }

    if (
      worldEatersRelentless &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "melee"
    ) {
      if (!weaponStats[chosenWeaponNameDif].extraAttacks) {
        weaponStats[chosenWeaponNameDif].attackString = addToString(
    ...
    if (
      stratagemGround &&
      (weaponStats[chosenWeaponNameDif].invul == 0 ||
        isNaN(weaponStats[chosenWeaponNameDif].invul)) &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "ranged"
    ) {
    ...
    if (
      weaponStats[chosenWeaponNameDif].rapidFireCount
        .toUpperCase()
        .includes("D")
    ) {
    ...
    if (weaponStats[chosenWeaponNameDif].melta && halfRange) {
      if (weaponStats[chosenWeaponNameDif].rollDamage) {
        let splitDamageString =
          weaponStats[chosenWeaponNameDif].damageString.split("+");
        if (splitDamageString.length == 2) {
          splitDamageString[1] =
            parseInt(splitDamageString[1]) +
            weaponStats[chosenWeaponNameDif].meltaCount;
          weaponStats[chosenWeaponNameDif].damageString =
            splitDamageString.join("+");
        } else {
          weaponStats[chosenWeaponNameDif].damageString =
            splitDamageString[0] +
            "+" +
    ...
    weaponStats[chosenWeaponNameDif].wound = woundRollVal(
      weaponStats[chosenWeaponNameDif].strength,
      weaponStats[chosenWeaponNameDif].toughness
    );

    // console.log(`wound: ${wound}`)

    // console.log(`anti: ${weaponStats[chosenWeaponNameDif].anti}`)
    ...
    if (weaponStats[chosenWeaponNameDif].anti) {
      ...
      let antiValuesArray =
        weaponStats[chosenWeaponNameDif].antiValue.split(", ");
      ...
      for (let a = 0, b = antiArray.length; a < b; a++) {
        for (let c = 0, d = defenderKeywordsArray.length; c < d; c++) {
          if (antiArray[a] == defenderKeywordsArray[c]) {
            ...
            if (
              antiValuesArray[a] <
              weaponStats[chosenWeaponNameDif].criticalWound
            ) {
              weaponStats[chosenWeaponNameDif].criticalWound =
                antiValuesArray[a];
            }
    ...
    if (
      cover &&
      (weaponStats[chosenWeaponNameDif].save > 3 ||
        weaponStats[chosenWeaponNameDif].ap > 0) &&
      !weaponStats[chosenWeaponNameDif].ignoresCover &&
      weaponStats[chosenWeaponNameDif].weaponMeleeRanged == "ranged"
    ) {
    ...
    if (
      ...
      if (
        weaponStats[chosenWeaponNameDif].save >
        weaponStats[chosenWeaponNameDif].invul
      ) {
        weaponStats[chosenWeaponNameDif].save =
          weaponStats[chosenWeaponNameDif].invul;
      }
    ...
    if (halveDamage && !weaponStats[chosenWeaponNameDif].rollDamage) {
      weaponStats[chosenWeaponNameDif].damageString = Math.ceil(
        damageString / 2
      );
    }
    ...
    weaponStats[chosenWeaponNameDif].originalAttackString =
      weaponStats[chosenWeaponNameDif].attackString;
    weaponStats[chosenWeaponNameDif].originalDamageString =
      weaponStats[chosenWeaponNameDif].damageString;
  ...
  while (i < simulations) {
    ...
    weaponSelectEls.forEach((weaponEl) => {
      ...
      if (chosenWeaponStats.worldEatersGlaiveCharged) {
        ...
        chosenWeaponStats.attackString = addToString(
          chosenWeaponStats.rollAttacks,
          chosenWeaponStats.attackString,
          tempD3
        );
        chosenWeaponStats.damageString = addToString(
          chosenWeaponStats.rollDamage,
          chosenWeaponStats.damageString,
          tempD3
        );
      }
      ...
      if (chosenWeaponStats.rollAttacks) {
        ...
        for (let i = 0, j = chosenWeaponStats.attackerCount; i < j; i++) {
          let tempAttackRoll = calcDiceRollsInString(
            chosenWeaponStats.attackString
          );
          if (tempAttackRoll < 1) {
            attacks += 1;
        ...
        attacks =
          parseInt(chosenWeaponStats.attackString) *
          chosenWeaponStats.attackerCount;
        // console.log(`attacks: ${attacks}`)
      }
      ...
      if (halfRange && chosenWeaponStats.rapidFire) {
        ...
        if (chosenWeaponStats.rollRapidFire) {
          ...
          attacks +=
            parseInt(chosenWeaponStats.rapidFireCount) *
            chosenWeaponStats.attackerCount;
        }
      ...
      if (chosenWeaponStats.blast) {
        attacks +=
          chosenWeaponStats.attackerCount * Math.floor(defenderCount / 5);
      }
      ...
      if (!chosenWeaponStats.torrent) {
        ...
        if (oneRerollAttackChain && !usedSingleReroll) {
          ...
          diceResults.forEach((roll, index) => {
            if (
              roll + chosenWeaponStats.hitModifier < chosenWeaponStats.hit &&
              !usedSingleReroll
            ) {
        ...
        if (rerollAllHits) {
          ...
          //get any fails's
          let failedHitRolls = diceResults.filter(
            (result) =>
              result == 1 ||
              result + chosenWeaponStats.hitModifier < chosenWeaponStats.hit
          );
          ...
          diceResults = diceResults.filter(
            (result) =>
              result != 1 &&
              result + chosenWeaponStats.hitModifier >= chosenWeaponStats.hit
          );
        ...
        let criticalHitDice = diceResults.filter(
          (result) => result >= chosenWeaponStats.criticalHit
        );
        diceResults = diceResults.filter(
          (result) => result < chosenWeaponStats.criticalHit
        );
        ...
        if (chosenWeaponStats.sustainedHits) {
          ...
          for (let a = 0, b = criticalHitDice.length; a < b; a++) {
            for (
              let c = 0, d = chosenWeaponStats.sustainedHitsCount;
              c < d;
              c++
            ) {
        ...
        if (chosenWeaponStats.lethalHits) {
          lethalHitStorage = diceResults.filter(
            (result) => result >= chosenWeaponStats.criticalHit
          );
          diceResults = diceResults.filter(
            (result) => result < chosenWeaponStats.criticalHit
      ...
      if (oneRerollAttackChain && !usedSingleReroll) {
        ...
        diceResults.forEach((roll, index) => {
          if (
            roll + chosenWeaponStats.woundModifier <
            chosenWeaponStats.wound
          ) {
            diceResults[index] = rollDice6();
            usedSingleReroll = true;
          }
      ...
      let criticalWoundDice = diceResults.filter(
        (result) => result >= chosenWeaponStats.criticalWound
      );
      ...
      if (rerollAllWounds || chosenWeaponStats.twinLinked) {
        ...
        //get any fails's
        let failedWoundRolls = diceResults.filter(
          (result) =>
            result == 1 ||
            result + chosenWeaponStats.woundModifier < chosenWeaponStats.wound
        );
        ...
        if (failedWoundRolls.length > 0) {
          ...
          diceResults = diceResults.filter(
            (result) =>
              result + chosenWeaponStats.woundModifier >=
              chosenWeaponStats.wound
          );
          // console.log(`old roll, fails's removed: ${diceResults}`);
          // console.log(`old roll, fails's removed array length: ${diceResults.length}`);
      ...
      if (
        !chosenWeaponStats.devastatingWounds &&
      ...
      if (rerollAllSaves) {
        ...
        //get any fails's
        let failedSaveRolls = diceResults.filter(
          (result) => result == 1 || result < chosenWeaponStats.save
        );
      ...
      diceResults = diceResults.filter(
        (result) => result < chosenWeaponStats.save
      );

      //
      if (
        weaponStats[chosenWeaponNameDif].criticalWoundAp > 0 &&
        !weaponStats[chosenWeaponNameDif].devastatingWounds
      ) {
        let tempRecalcedSave =
          chosenWeaponStats.save +
          weaponStats[chosenWeaponNameDif].criticalWoundAp;

        if (
          chosenWeaponStats.invul != 0 &&
          chosenWeaponStats.save +
            weaponStats[chosenWeaponNameDif].criticalWoundAp >
            chosenWeaponStats.invul
        ) {
          tempRecalcedSave = chosenWeaponStats.invul;
        }

        criticalWoundDice = criticalWoundDice.filter(
          (result) => result < tempRecalcedSave
        );
      ...
      for (let a = 0, b = diceResults.length; a < b; a++) {
        ...
        if (chosenWeaponStats.rollDamage) {
          let tempDiceRoll = calcDiceRollsInString(
            chosenWeaponStats.damageString
          );
          if (tempDiceRoll < 1) {
            tempDiceRoll = 1;
      ...
      for (let a = 0, b = mortalWounds; a < b; a++) {
        if (
          (chosenWeaponStats.fnp != 0 && !isNaN(chosenWeaponStats.fnp)) ||
          custodesAegis
        ) {
          if (
            custodesAegis &&
            (chosenWeaponStats.fnp == 0 || chosenWeaponStats.fnp > 4)
          ) {
            if (rollDice6() < 4) {
              finalWoundsDealt += 1;
      ...
      let defendersKilledByThisWeapon =
        deadDefenders - deadDefendersBeforeThisWeapon;

      weaponOverallDeadDefenderResultsObj[chosenWeaponNameDif].push(
        defendersKilledByThisWeapon
      );
    ...
    overAllResults.combinedWounds[i] += finalWoundsDealt;
    overAllResults.combinedKills[i] +=
      deadDefenders - deadDefendersBeforeThisWeapon;
    ...
    if (
      necronsReanimation &&
      reanimationDeadDefenders < defenderCount &&
      overAllResults.combinedWounds[i] > 0
    ) {
      ...
      if (wounds == 1) {
        ...
        if (reanimationDeadDefenders < 0) {
          ...
          reanimationWoundsHealed.push(
            reanimationRoll + reanimationDeadDefenders
          );
          reanimationModelsReanimated.push(
            reanimationRoll + reanimationDeadDefenders
          );
    ...
    if (hazardous) {
      for (let a = 0, b = hazardousWeaponCount; a < b; a++) {
        if (rollDice6() === 1) {
          if (
            attackerKeywords.includes("Character") ||
            attackerKeywords.includes("Monster") ||
            attackerKeywords.includes("Vehicle")
          ) {
            hazardousWounds += 3;
          } else {
  ...
  for (const result in weaponOverallResultsObj) {
    ...
    weaponOverallResultsObj[result].average =
      totalSimulationDamage / simulations;
  }
  ...
  for (const result in weaponOverallDeadDefenderResultsObj) {
    ...
    weaponOverallDeadDefenderResultsObj[result].average =
      totalSimulationKills / simulations;
  }
  ...
  overAllResults.combinedWipesAverage =
    ((100 / simulations) * overAllResults.combinedWipes.length).toFixed(2) * 1;
  ...
  if (necronsReanimation) {
    ...
    averageReanimations =
      (
        totalSimulationReanimations / reanimationModelsReanimated.length
      ).toFixed(2) * 1;
    ...
    averageReanimationHeal =
      (totalSimulationReanimationHeal / reanimationWoundsHealed.length).toFixed(
        2
      ) * 1;
  ...
  weaponSelectEls.forEach((weaponEl) => {
    ...
    weaponStats[
      chosenWeaponNameDif
    ].weaponsBarString = `<div class="inner_bar inner_bar-${weaponStats[chosenWeaponNameDif].name}-${weaponStats[chosenWeaponNameDif].weaponMeleeRanged}"></div>`;
  });

  informationHTML = `<div class="simulation_header">Over <span class="value">${simulations}</span> simulations:</div><div class="simulation_title">Total</div><div>Average damage (rounded): <span class="value">${Math.round(
    overAllResults.combinedWoundsAverage
  )}</span></div><div>Average kills (rounded): <span class="value">${Math.round(
    overAllResults.combinedKillsAverage
  )}</span></div>${weaponsStrings}${grenadeString}${tankShockString}${necronReanimationString}<div class="simulation_kill_perc">percentage chance to fully wipe the target unit: <span class="value">${
    overAllResults.combinedWipesAverage
  }%</span></div>${hazardousString}`;
  ...
  let weaponColours = generateColours(
    colours[selectedAttackerFaction],
    Object.values(weaponOverallResultsObj).length
  );
  ...
  for (const count in chartTotal) {
    ...
    for (const weapon in weaponOverallResultsObj) {
      ...
      sortingArr.push({
        num:
          100 /
          (overAllResults.combinedWoundsAverage /
            weaponOverallResultsObj[weapon].average),
        html: `<div style="width: 100%; height:${
          100 /
          (overAllResults.combinedWoundsAverage /
            weaponOverallResultsObj[weapon].average)
        }%; background-color: ${
          weaponColours[
            Object.values(weaponOverallResultsObj).indexOf(
              weaponOverallResultsObj[weapon]
            )
          ]
        };"></div>`,
      });
    ...
    barHTML += `<div class='bar' id='bar_${count}' style='height:${
      100 / (max / chartTotal[count])
    }%; width:calc(${
      100 / maxMinArr.length
    }% - 2px); margin: 0px 1px;'><div class='label'>${count}<span class='sublabel'>${
      chartTotal[count]
    }</span></div>${weaponBarFill}</div>`;
  }
  ...
  weaponSelectEls.forEach((weaponEl) => {
    ...
    keyHTML += `<div class="chart_key_element"><div class="chart_key_label">${
      weaponStats[chosenWeaponNameDif].name
    }</div><div class="chart_key_colour" style="background-color:${
      weaponColours[
        Object.values(weaponOverallResultsObj).indexOf(
          weaponOverallResultsObj[chosenWeaponNameDif]
        )
...
function attackerFactionChange() {
  ...
  document
    .querySelectorAll(".select_container")
    .forEach((el) => (el.style.height = "calc( 25px * 2 )"));
  //reet the attacker html bits
  weaponContainer.innerHTML = "";
  extraWeaponContainer.innerHTML = "";

  selectedAttackerFaction = attackerFactionSelectEl.value;
  attackerUnitSelectEl.innerHTML = generateUnitSelectHtml(
    selectedAttackerFaction
  );
  document
    .querySelector(".factionAttacker")
    .querySelectorAll(".faction_modifier_container")
    .forEach((element) => {
  ...
  if (
    selectedAttackerFaction == "adeptusAstartes" ||
    selectedAttackerFaction == "blackTemplars" ||
    selectedAttackerFaction == "bloodAngels" ||
    selectedAttackerFaction == "darkAngels" ||
    selectedAttackerFaction == "deathwatch" ||
    selectedAttackerFaction == "spaceWolves"
  ) {
    if (selectedAttackerFaction == "adeptusAstartes") {
      ...
      document.querySelector(
        `#attacker_faction-adeptusAstartes`
      ).style.display = "block";
    }
  }

  document.querySelector(
    `#attacker_faction-${selectedAttackerFaction}`
  ).style.display = "block";

  //hide scenario modifiers
  document
    .querySelectorAll(".scenario_modifier:not(.scenario_cover)")
    .forEach((element) => {
      element.style.display = "none";
    });
...
function defenderFactionChange() {
  ...
  defenderUnitSelectEl.innerHTML = generateUnitSelectHtml(
    selectedDefenderFaction
  );
  document
    .querySelector(".factionDefender")
    .querySelectorAll(".faction_modifier_container")
    .forEach((element) => {
      element.style.display = "none";
      element.querySelectorAll("input[type=checkbox]").forEach((el) => {
  ...
  document.querySelector(
    `#defender_faction-${selectedDefenderFaction}`
  ).style.display = "block";
...
function showSetUpFactionAbilities() {
  switch (selectedAttackerFaction) {
    case "adeptaSororitas":
      document.querySelector(`#attackerBelowStartingStrength`).style.display =
        "block";
      document.querySelector(`#attackerBelowHalfStrength`).style.display =
        "block";
      break;
...
function attackerUnitChange() {
  ...
  let selectedAttackerData =
    data[selectedAttackerFaction].units[selectedAttackerUnit].tags;
  ...
  //enhancements
  document
    .querySelector(".enhancementAttacker")
    .querySelectorAll(".faction_enhancement_container")
    .forEach((element) => {
      element.style.display = "none";
      element.querySelectorAll("input[type=checkbox]").forEach((el) => {
        el.checked = false;
  ...
  let canHaveEnhancement =
    selectedAttackerData.includes("Character") &&
    !selectedAttackerData.includes("Epic Hero");
  if (canHaveEnhancement) {
    document.querySelector(
      `#attacker_enhancement-${selectedAttackerFaction}`
    ).style.display = "block";
  }

  if (
    data[selectedAttackerFaction].units[selectedAttackerUnit].hasOwnProperty(
      "leader"
    )
  ) {
    if (data[selectedAttackerFaction].units[selectedAttackerUnit].leader) {
      let extraAttackerHTML = '<option value="null">-</option>';
      data[selectedAttackerFaction].units[
      ...
      document
        .querySelectorAll(".select_container")
        .forEach((el) => (el.style.height = "calc( 25px * 3 )"));

      document.querySelector("#attackers_extra_select").innerHTML =
        extraAttackerHTML;
      ...
      document
        .querySelector("#attackers_extra_select")
  ...
  document
    .querySelector(".stratagemAttacker")
    .querySelectorAll(".faction_stratagem_sub_container")
    .forEach((element) => {
      element.style.display = "none";
      element
        .querySelectorAll(".faction_stratagem_container_element")
        .forEach((el) => {
  ...
  document
    .querySelector(".stratagemAttacker")
    .querySelectorAll(
      `.faction_stratagem_sub_container-${selectedAttackerFaction}`
    )
    .forEach((element) => {
  ...
  if (selectedAttackerData.includes("Vehicle")) {
    document
      .querySelector(".stratagemAttacker")
      .querySelector(`.faction_stratagem_sub_container-generic`).style.display =
      "block";
    document.querySelector(`#genericStratagemTankShockCont`).style.display =
      "block";
  }
  if (selectedAttackerData.includes("Grenades")) {
    document
      ...
      .querySelector(`.faction_stratagem_sub_container-generic`).style.display =
      "block";
    document.querySelector(`#genericStratagemGrenadeCont`).style.display =
      "block";
  }
}
...
function defenderUnitChange() {
  ...
  let selectedDefenderData =
    data[selectedDefenderFaction].units[selectedDefenderUnit].tags;
  populateDefender(selectedDefenderFaction, selectedDefenderUnit);
  document
    .querySelector(".enhancementDefender")
    .querySelectorAll(".faction_enhancement_container")
    .forEach((element) => {
      element.style.display = "none";
      element.querySelectorAll("input[type=checkbox]").forEach((el) => {
  ...
  let canHaveEnhancement =
    selectedDefenderData.includes("Character") &&
    !selectedDefenderData.includes("Epic Hero");
  if (canHaveEnhancement) {
    document.querySelector(
      `#defender_enhancement-${selectedDefenderFaction}`
    ).style.display = "block";
  }
  //hide all stratagems and untick all stratagem boxes
  document
    .querySelector(".stratagemDefender")
    .querySelectorAll(".faction_stratagem_sub_container")
    .forEach((element) => {
      element.style.display = "none";
      element
  ...
  document
    .querySelector(".stratagemDefender")
    .querySelectorAll(
      `.faction_stratagem_sub_container-${selectedDefenderFaction}`
    )
    .forEach((element) => {
      element.style.display = "block";
      element
  ...
  if (selectedDefenderData.includes("Infantry")) {
    document
      .querySelector(".stratagemDefender")
      .querySelector(`.faction_stratagem_container`).style.display = "block";
    document.querySelector(`#genericStratagemGroundCont`).style.display =
      "block";
  }
  if (selectedDefenderData.includes("Smoke")) {
    document
      .querySelector(".stratagemDefender")
      .querySelector(`.faction_stratagem_container`).style.display = "block";
    document.querySelector(`#genericStratagemSmokeCont`).style.display =
      "block";
  }
}
...
function populateWeaponContainer(selectedFaction, selectedUnit) {
  ...
  let selectedUnitRangedWeapons =
    data[selectedFaction].units[selectedUnit].weapons.ranged;
  let selectedUnitMeleeWeapons =
    data[selectedFaction].units[selectedUnit].weapons.melee;
  ...
  if (Object.keys(selectedUnitRangedWeapons).length > 0) {
    ...
    for (const weapon in selectedUnitRangedWeapons) {
      weaponContainerHTML += `<div class="weapon" id="weapon${weapon}-ranged-main" style="background-color:${tempMakeTransparent(
        colours[selectedFaction]
      )};"><div class="weapon_bar" style="background-color:${
        colours[selectedFaction]
      };"></div> <input type="checkbox" class="weapon_select" id="weaponSelect${weapon}-ranged" data-weapon-type="ranged" data-faction="${selectedFaction}" data-unit="${selectedUnit}" data-weapon="${weapon}" data-weapon-extra="main" /> <div class="weapon_label">${
        selectedUnitRangedWeapons[weapon].name
      }</div><div class="weapon_attribute"> <div class="label">No.</div><input type="text" id="attackerCount${weapon}-ranged" value="${
        selectedUnitRangedWeapons[weapon].maxPerUnit
      }"/> </div><div class="weapon_attribute"> <div class="label">A</div><input type="text" id="attacks${weapon}-ranged" value="${
        selectedUnitRangedWeapons[weapon].a
      }"/> </div><div class="weapon_attribute"> <div class="label">BS</div><input type="text" id="wbs${weapon}-ranged" value="${
        selectedUnitRangedWeapons[weapon].wbs
      }"/> </div><div class="weapon_attribute"> <div class="label">S</div><input type="text" id="strength${weapon}-ranged" value="${
        selectedUnitRangedWeapons[weapon].s
      }"/> </div><div class="weapon_attribute"> <div class="label">AP</div><input type="text" id="ap${weapon}-ranged" value="${
        selectedUnitRangedWeapons[weapon].ap
      }"/> </div><div class="weapon_attribute"> <div class="label">D</div><input type="text" id="damage${weapon}-ranged" value="${
        selectedUnitRangedWeapons[weapon].d
      }"/> </div><div class="label weapon_tags_label">Tags</div><input type="text" class="weapon_tags" id="weaponTags${weapon}-ranged" value="${selectedUnitRangedWeapons[
        weapon
      ].tags.join(", ")}" /></div>`;
    }
  }
  ...
  if (Object.keys(selectedUnitMeleeWeapons).length > 0) {
    ...
    for (const weapon in selectedUnitMeleeWeapons) {
      weaponContainerHTML += `<div class="weapon" id="weapon${weapon}-melee-main" style="background-color:${tempMakeTransparent(
        colours[selectedFaction]
      )};"><div class="weapon_bar" style="background-color:${
        colours[selectedFaction]
      };"></div> <input type="checkbox" class="weapon_select" id="weaponSelect${weapon}-melee" data-weapon-type="melee" data-faction="${selectedFaction}" data-unit="${selectedUnit}" data-weapon="${weapon}" data-weapon-extra="main" /> <div class="weapon_label">${
        selectedUnitMeleeWeapons[weapon].name
      }</div><div class="weapon_attribute"> <div class="label">No.</div><input type="text" id="attackerCount${weapon}-melee" value="${
        selectedUnitMeleeWeapons[weapon].maxPerUnit
      }"/> </div><div class="weapon_attribute"> <div class="label">A</div><input type="text" id="attacks${weapon}-melee" value="${
        selectedUnitMeleeWeapons[weapon].a
      }"/> </div><div class="weapon_attribute"> <div class="label">WS</div><input type="text" id="wbs${weapon}-melee" value="${
        selectedUnitMeleeWeapons[weapon].wbs
      }"/> </div><div class="weapon_attribute"> <div class="label">S</div><input type="text" id="strength${weapon}-melee" value="${
        selectedUnitMeleeWeapons[weapon].s
      }"/> </div><div class="weapon_attribute"> <div class="label">AP</div><input type="text" id="ap${weapon}-melee" value="${
        selectedUnitMeleeWeapons[weapon].ap
      }"/> </div><div class="weapon_attribute"> <div class="label">D</div><input type="text" id="damage${weapon}-melee" value="${
        selectedUnitMeleeWeapons[weapon].d
      }"/> </div><div class="label weapon_tags_label">Tags</div><input type="text" class="weapon_tags" id="weaponTags${weapon}-melee" value="${selectedUnitMeleeWeapons[
        weapon
      ].tags.join(", ")}" /></div>`;
    }
  }
  ...
  weaponContainerHTML += `<div class="attacker_tags_label">Keywords</div><textarea class="attacker_tags" id="attackerTags">${data[
    selectedFaction
  ].units[selectedUnit].tags.join(", ")}</textarea>`;
...
function populateExtraWeaponContainer(selectedFaction, selectedUnit) {
  ...
  if (Object.keys(selectedUnitRangedWeapons).length > 0) {
    weaponContainerHTML += '<div class="bold weapon_type_label">Ranged</div>';
    for (const weapon in selectedUnitRangedWeapons) {
      weaponContainerHTML += `<div class="weapon" id="weapon${weapon}-ranged-extra" style="background-color:${tempMakeTransparent(
        colours[selectedFaction]
      )};"><div class="weapon_bar" style="background-color:${
        colours[selectedFaction]
      };"></div> <input type="checkbox" class="weapon_select" id="weaponSelect${weapon}-ranged" data-weapon-type="ranged" data-faction="${selectedFaction}" data-unit="${selectedUnit}" data-weapon="${weapon}" data-weapon-extra="extra" /> <div class="weapon_label">${
        selectedUnitRangedWeapons[weapon].name
      }</div><div class="weapon_attribute"> <div class="label">No.</div><input type="text" id="attackerCount${weapon}-ranged" value="${
        selectedUnitRangedWeapons[weapon].maxPerUnit
      }"/> </div><div class="weapon_attribute"> <div class="label">A</div><input type="text" id="attacks${weapon}-ranged" value="${
  ...
  if (Object.keys(selectedUnitMeleeWeapons).length > 0) {
    weaponContainerHTML += '<div class="bold weapon_type_label">Melee</div>';
    for (const weapon in selectedUnitMeleeWeapons) {
      weaponContainerHTML += `<div class="weapon" id="weapon${weapon}-melee-extra" style="background-color:${tempMakeTransparent(
        colours[selectedFaction]
      )};"><div class="weapon_bar" style="background-color:${
        colours[selectedFaction]
      };"></div> <input type="checkbox" class="weapon_select" id="weaponSelect${weapon}-melee" data-weapon-type="melee" data-faction="${selectedFaction}" data-unit="${selectedUnit}" data-weapon="${weapon}" data-weapon-extra="extra" /> <div class="weapon_label">${
        selectedUnitMeleeWeapons[weapon].name
      }</div><div class="weapon_attribute"> <div class="label">No.</div><input type="text" id="attackerCount${weapon}-melee" value="${
        selectedUnitMeleeWeapons[weapon].maxPerUnit
      }"/> </div><div class="weapon_attribute"> <div class="label">A</div><input type="text" id="attacks${weapon}-melee" value="${
...
function registerWeaponClicks() {
  ...
  weaponSelectEls.forEach((el) => {
    el.addEventListener("click", (event) => {
      ...
      let weaponTags = document
        .querySelector(
          "#weaponTags" +
            el.getAttribute("data-weapon") +
            "-" +
            el.getAttribute("data-weapon-type")
        )
        .value.split(", ");
      weaponTags.forEach((tag) => {
        switch (tag.split("-")[0]) {
...
function populateDefender(selectedFaction, selectedUnit) {
  ...
  defenderHTML = `<div class="defender_stats" data-name="${selectedUnit}" style="background-color:${tempMakeTransparent(
    colours[selectedFaction]
  )};"><div class="defender_bar" style="background-color:${
    colours[selectedFaction]
  };"></div><div class="defender_label">${
    selectedData.name
  }</div><div class="defender_attribute"><div class="label">No.</div><input type="text" id="defenderCount-${selectedUnit}" value="${
    selectedData.size
  }"/> </div><div class="defender_attribute"> <div class="label">T</div> <input type="text" id="toughness-${selectedUnit}" value="${
    selectedData.t
  }" /></div><div class="defender_attribute"> <div class="label">Sv</div> <input type="text" id="save-${selectedUnit}" value="${
    selectedData.sv
  }" /></div><div class="defender_attribute"> <div class="label">Invul</div> <input type="text" id="invul-${selectedUnit}" value="${
    selectedData.invSv
  }" /></div><div class="defender_attribute"> <div class="label">W</div> <input type="text" id="wounds-${selectedUnit}" value="${
    selectedData.w
  }" /></div><div class="defender_attribute"> <div class="label">FnP</div> <input type="text" id="fnp-${selectedUnit}" value="${
    selectedData.fnp
  }" /></div><div class="label defender_tags_label">Tags</div><textarea class="defender_tags" id="defenderTags-${selectedUnit}">${defenderKeywordString}</textarea></div>`;
  // }else{
...
function toggleModifiersVisible() {
  if (!modifierContainerExpanded) {
    ...
    document.getElementById("modifiers").style.height =
      document.querySelector("#modifiers").querySelector(".attacker")
        .scrollHeight + "px";
  } else {
...
document
  .getElementById("bloodAngelsEnhancementAttackerShard")
  .addEventListener("change", () => {
    if (
      document.getElementById("bloodAngelsEnhancementAttackerShard").checked
    ) {
      chargedContainer.style.display = "block";
    } else {
      chargedContainer.style.display = "none";
...
document
  .getElementById("worldEatersEnhancementGlaive")
  .addEventListener("change", () => {
...
let modifierAttackerHeight = document
  .querySelector("#modifiers")
  .querySelector(".attacker").scrollHeight;
...
// let outHTML = '';
// deathWatchBoltWeaponsArr.forEach((el, i) => {

//     let splitEl = el.split(' ');

//     splitEl.forEach((text, index) => {
//         splitEl[index] = text.charAt(0).toUpperCase() + text.slice(1)
//     })

//     if(i>0){
//         outHTML+=', '
//     }
//     outHTML += `'${splitEl.join(' ')}'`
// });
// document.querySelector('#testOut').innerText = outHTML;
